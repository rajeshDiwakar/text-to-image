...
parser.add_argument('--num_resnet',type=int,default=2)
...
NUM_TOKENS = args.num_tokens#8192
NUM_LAYERS = args.num_layers
NUM_RESNET_BLOCKS = args.num_resnet #2
SMOOTH_L1_LOSS = False
EMB_DIM = args.codebook_dim#512
HID_DIM = args.hidden_dim#256
KL_LOSS_WEIGHT = 0
