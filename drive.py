...
class MyDrive(object):
    def __init__(self):
        if os.path.isfile('nodrive'):
            ...
            self.download_checkpoints = self.fake_download_checkpoints
            return
        else:
    ...
    def fake_download_checkpoints(*args,**kwargs):
        pass
...
#             raise ValueError('No folders match that specified folder name')
    ...
    def _download_checkpoints(self,parent_id,checkpoint,root_dir='outdir'):
        drive =self.authorize_drive()
        downloaded_files = []
    ...
    #
        ...
        if os.path.isfile(ckpt_path):
            ...
            print('checkpoint file not found in drive')
