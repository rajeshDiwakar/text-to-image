...
def train(args):
    ...
    batch_size = 128
    hymenoptera_dataset = datasets.ImageFolder(root='dataset/images',
                                               transform=data_transform)
    dataset_loader = torch.utils.data.DataLoader(hymenoptera_dataset,
                                                 batch_size=128, shuffle=True,
                                                 num_workers=4)
    dataset_loader_test = torch.utils.data.DataLoader(hymenoptera_dataset,
...
def test(args):
    ...
    # load dataset
    hymenoptera_dataset = datasets.ImageFolder(root='dataset',
                                               transform=data_transform)
    dataset_loader = torch.utils.data.DataLoader(hymenoptera_dataset,
